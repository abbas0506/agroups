    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                <a href="/" class="mr-5 hover:text-gray-900 hover:bg-gray-50 p-2 hover:rounded">Home</a>
                <a class="mr-5 hover:text-gray-900  hover:bg-gray-50 p-2 hover:rounded">Courses</a>
                <a class="mr-5 hover:text-gray-900  hover:bg-gray-50 p-2 hover:rounded">Team</a>
                <a href="{{ url('contact-us') }}"
                    class="mr-5 hover:text-gray-900  hover:bg-gray-50 p-2 hover:rounded">Contact Us</a>
            </nav>
            <button
