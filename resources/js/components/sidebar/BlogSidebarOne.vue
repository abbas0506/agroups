    ...
    <div class="edu-blog-sidebar">
                ...
                <div class="content">
                    <ul class="category-list">
                        <li v-for="(cat, index) in categories.slice(0, 6)" :key="index">
                            <a to="/blog/blog-masonry">{{ cat.title }} <span>({{ cat.number }})</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="edu-blog-widget widget-action">
            <div class="inner">
                ...
                <a to="/course/course-one" class="edu-btn btn-medium">Start Now <i class="icon-4"></i></a>
            </div>
        </div>
                ...
                <div class="content">
                    <ul class="category-list">
                        <li v-for="(archive, index) in archives.slice(0, 5)" :key="index">
                            <a to="/blog/blog-masonry">{{ archive.title }} <span>({{ archive.number }})</span></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="edu-blog-widget widget-tags">
            <div class="inner">
                ...
                <div class="content">
                    <div class="tag-list">
                        <a to="/blog/blog-masonry" v-for="(tag, index) in tags.slice(0, 5)" :key="index">{{ tag }}</a>
                    </div>
                </div>
            </div>
        </div>
