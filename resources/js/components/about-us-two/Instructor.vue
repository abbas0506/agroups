        ...
        <div class="container">
            ...
            <div class="row row--45 g-5">
                <div class="col-lg-4 col-md-6" data-aos-delay="100" data-aos="fade-up" data-aos-duration="800"
                    v-for="(instructor, key) in instructorData.instructors.slice(0, 3)" :key="key">
                    <InstructorFive :instructor="instructor" />
                </div>
            </div>
        </div>
...
import InstructorFive from "../instructor/InstructorFive";
export default {
    components: {
        SectionTitle,
        InstructorFive,
