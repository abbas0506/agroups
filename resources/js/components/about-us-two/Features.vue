    ...
    <section class="why-choose-area-3 edu-section-gap">
        <div class="container">
            <div class="row row--45">
                <div class="section-title-flex section-title" data-aos-delay="150" data-aos="fade-up"
                    data-aos-duration="800">
                    <div class="left-content">
                        <h2 class="title">We Providing The <br> Best <span class="color-secondary">Quality Online
                            </span> Courses</h2>
                        <span class="shape-line"><i class="icon-19"></i></span>
                    </div>
                    <div class="right-content">
                        <p>Lorem ipsum dolor sit amet cons etur adipisicing elit sed do eiusm aut tempor incididunt
                            labore dolore magna aliqua quis nostrud ex ertation lamcolab oris aliquip.</p>
                    </div>
                </div>
            </div>
        ...
        <ul class="shape-group">
            ...
            <li class="shape-3">
                <img class="rellax" data-rellax-speed="-1.3" data-rellax-xs-speed="-1.3" data-rellax-mobile-speed="-0.5"
                    data-rellax-tablet-speed="-0.5" src="/images/faq/shape-12.png" alt="shape" />
            </li>
        </ul>
    </section>
</template>
