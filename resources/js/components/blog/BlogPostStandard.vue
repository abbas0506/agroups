        ...
        <div class="inner">
            <div class="thumbnail">
                <div class="blog-gallery-activation" v-if="blogInfo.slider">
                    <swiper class="swiper" :options="swiperOptions">
                        <div class="swiper-slide" v-for="(sliderThumb, i) in blogInfo.slider" :key="i">
            ...
            <div class="content">
                <div class="category-wrap">
                    <a to="/blog/blog-masonry" class="blog-category">{{ blogInfo.category }}</a>
                </div>
                <h3 class="title">
                    <a to="/blog/blog-details">{{ blogInfo.title }}</a>
                </h3>
                <ul class="blog-meta">
                ...
                <div class="read-more-btn">
                    <a to="/blog/blog-details" class="edu-btn btn-border btn-medium">
                        Learn More <i class="icon-4"></i>
                    </a>
                </div>
            </div>
        </div>
        <CoolLightBox :items="blogInfo.video !== undefined ? blogInfo.video : []" :index="index" @close="index = null">
        </CoolLightBox>
    </div>
</template>
