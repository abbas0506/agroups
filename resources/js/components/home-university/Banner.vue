    ...
    <div class="hero-banner university-banner-section bg-image bg-image--17">
        <div class="container edublink-animated-shape">
                ...
                <div class="col-xl-6 col-lg-7">
                    <div class="banner-content">
                        ...
                        <div class="banner-btn">
                            <a to="/course/course-one" class="edu-btn btn-secondary">Find courses <i
                                    class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <ul class="shape-group">
                <MouseMove addClassName="shape-1" dataDepth="2" data-aos-delay="200" data-aos="fade"
                    data-aos-duration="200" imgSrc="/images/others/shape-10.png" />
