<template>
    <div class="edu-categorie-area categorie-area-3 edu-section-gap bg-image bg-image--4" id="categories">
        <div class="container">
            <SectionTitle alignment="section-center" preTitle='CATEGORIES' preTitleClass="pre-textsecondary"
            ...
            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 g-4">
                <div class="col" data-aos-delay="100" data-aos="fade-up" data-aos-duration="800"
