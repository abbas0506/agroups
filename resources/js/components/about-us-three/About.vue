            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="about-content">
                        <SectionTitle preTitle='About Us'
                            title='We Provide Best <span class="color-secondary">Freelancing Skills</span> For You.'
                            subTitle='' alignment='section-left' />
                        ...
                        <div class="about-mission">
                            <div class="single-item" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800">
                                ...
                                <div class="content">
                                    ...
                                    <p>To Develop Skillfull Persons all over the Paksitan.</p>
                                </div>
                            </div>
                            <div class="single-item" data-aos-delay="150" data-aos="fade-up" data-aos-duration="800">
                                ...
                                <div class="content">
                                    ...
                                    <p>Provide facilites to start earing for every one.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="about-image-gallery">
                        <div class="row g-5">
                            <div class="col-6 masonry-item">
                                <div class="thumbnail thumbnail-1 mb--30" data-aos-delay="50" data-aos="fade-down"
                        ...
                        <ul class="shape-group">
                            <MouseMove addClassName="shape-1" dataDepth="2" imgSrc="/images/about/shape-33.png"
                                data-aos-delay="500" data-aos="fade" data-aos-duration="200" />
                            ...
                            <MouseMove addClassName="shape-3" dataDepth="-2" imgSrc="/images/about/shape-13.png"
                                data-aos-delay="500" data-aos="fade" data-aos-duration="200" />
                            <MouseMove addClassName="shape-4" dataDepth=".8" data-aos-delay="500" data-aos="fade"
